...
namespace AI
{
    ...
    public class DreadnoughtDecisionLogic : AIDecisionLogic
    {
        ...
        protected override void ExecuteUnitBehaviour(BasePiece dreadUnit)
        {
            if (dreadUnit == null)
                return;
        ...
        protected Point FindPointWithMultipleTargets()
        {
        ...
        protected Point FindClosestEnemyPoint()
        {
        ...
        protected void AttackWithDreadUnit()
        {
